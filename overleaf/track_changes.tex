...
\usepackage{changes}  %% <<< TRACK-CHANGES MARKUP (John's post-review tweaks + new Declarations). To hide all markup, change to: \usepackage[final]{changes}
\linenumbers
...
\begin{figure}
    \centering
    %% TODO(John, post-review): add pooled C_L = 1.07 m^2/s as a horizontal reference line in panel B (requires regenerating figures/summary.png; not a .tex-only change).
...
\added{Wind-driven tilting of the estuary water surface is a further potential source of error: a prior data report observed surface tilts of ${\sim}5$~cm under the sea breeze, so on windy days the gauge may register a lower $h$ and hence an apparent change in volume; by a rough estimate this bias is of order 0.1 m$^3$/s, comparable to the $Q_r$ error and to residual overwash.}
...
\section*{\added{Statements and Declarations}}

\added{\textbf{Funding.} This work was supported by the Sonoma County Water Agency (funding to the University of California Davis Bodega Marine Laboratory and to Environmental Science Associates for monitoring of estuary conditions in the Russian River) and by the California Department of Parks and Recreation (funding to the University of California Davis for monitoring and understanding water levels in California estuaries). Grant/award numbers to be confirmed.}

\added{\textbf{Competing Interests.} The authors declare no competing interests.}

\added{\textbf{Author Contributions.} [DRAFT for author confirmation.] O.C.: conceptualization, methodology, software, formal analysis, visualization, writing -- original draft; D.B.: conceptualization, data curation, writing -- review and editing; J.L.: conceptualization, funding acquisition, supervision, writing -- review and editing. All authors approved the submitted version.}

\added{\textbf{Data Availability.} The processed data and analysis code supporting this study are available at \url{https://github.com/octavia-crompton/russian-river-seepage}.}

\added{\textbf{Ethics Approval.} Not applicable; this study did not involve human participants or animals.}
