...
\author[ars]{Octavia V. Crompton\fnref{fn_oc}}
\fntext[fn_oc]{ORCID: 0000-0002-3576-6159}
\affiliation[ars]{organization={USDA-ARS Hydrology and Remote Sensing Laboratory}}

\author[epa]{Dane K. Behrens\fnref{fn_db}}
\fntext[fn_db]{ORCID: 0009-0009-1030-6605}
\affiliation[epa]{organization={Environmental Science Associates, San Francisco}}

\author[bml]{John L. Largier\fnref{fn_jl}}
\fntext[fn_jl]{ORCID: 0000-0003-4273-4443}
...
\begin{figure}
    \centering
    %% (John, post-review): add pooled C_L = 1.07 m^2/s as a horizontal reference line in panel B (requires regenerating figures/summary.png; not a .tex-only change).
...
\subsection*{Funding}
This work was supported by the Sonoma County Water Agency (funding to the University of California Davis Bodega Marine Laboratory and to Environmental Science Associates for monitoring of estuary conditions in the Russian River) and by the California Department of Parks and Recreation (funding to the University of California Davis for monitoring and understanding water levels in California estuaries).

\subsection*{Author Contributions}
O.V.C.: conceptualization, methodology, software, formal analysis, investigation, visualization, writing -- original draft, writing -- review and editing; D.K.B.: conceptualization, data curation, writing -- review and editing; J.L.: conceptualization, funding acquisition, writing -- review and editing. All authors read and approved the submitted version.

\subsection*{Data Availability}
The processed data and analysis code supporting this study are available at \url{https://github.com/octavia-crompton/russian-river-seepage}.

\subsection*{Ethics Approval}
Not applicable. This study did not involve human participants, animal subjects, or protected plant species.
